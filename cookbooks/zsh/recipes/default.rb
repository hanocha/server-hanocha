...
script 'install oh-my-zsh' do
  ...
  code <<-EOS
    ...
    sh $HOME/install.sh
  EOS
  not_if %Q{test -d $HOME/.oh-my-zsh}, environment: { 'HOME' => "/home/hanocha" }
end

template '/home/hanocha/.zshrc' do
  source '.zshrc'
  not_if %Q{cat /home/hanocha/.zshrc | grep '# Generated by chef template.'}
end